---@meta vscode-actions
-- Generated from VS Code keybindings.json (1007 unique command IDs).
-- Regenerate with gen-vscode-actions.py; see that script's docstring.
--
-- The trailing `string` member keeps the alias open: unknown command IDs
-- (e.g. from extensions not captured here) won't be flagged as errors,
-- but the literals below still drive completion. Delete the `---| string`
-- line to make the check strict.
...
---| "undo"
--- dataWrangler
---| "dataWrangler.applyOperation"
---| "dataWrangler.discardOperation"
---| "dataWrangler.revealNL2CodeWidget"
---| "dataWrangler.undoOperation"
--- debug
...
---| "workbench.action.chat.delegateToEditSession"
