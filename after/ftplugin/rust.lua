...
end, 'Rust: pick a runnable')
map('<LocalLeader>D', function()
  vim.cmd.RustLsp('debuggables')
end, 'Rust: pick a debuggable')
map('<LocalLeader>t', function()
  vim.cmd.RustLsp('testables')
end, 'Rust: pick a testable')
map('<LocalLeader>l', function()
  vim.cmd.RustLsp({ 'run', bang = true })
end, 'Rust: re-run last target')
map('<LocalLeader>j', function()
  vim.cmd.RustLsp({ 'debug', bang = true })
end, 'Rust: re-debug last target')
